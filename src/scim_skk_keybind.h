...
class KeyBind {
    ...
    KeyEventList m_latin_keys;
    KeyEventList m_wide_latin_keys;
    KeyEventList m_convert_keys;
    KeyEventList m_start_conv_keys;
    KeyEventList m_cancel_keys;
    KeyEventList m_latin_convert_keys;
...
public:
    ...
    void set_latin_keys         (String str);
    void set_wide_latin_keys    (String str);
    void set_convert_keys       (String str);
    void set_start_conv_keys    (String str);
    void set_cancel_keys        (String str);
    void set_latin_convert_keys (String str);
    ...
    bool match_latin_keys         (const KeyEvent &key);
    bool match_wide_latin_keys    (const KeyEvent &key);
    ...
    bool match_latin_convert_keys (const KeyEvent &key);
